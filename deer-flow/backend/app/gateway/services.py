...
from app.gateway.yqs_commands import start_yqs_command_run
...
async def start_run(
    ...
    try:
        yqs_record = await start_yqs_command_run(body, thread_id, request, owner_user_id=owner_user_id)
        if yqs_record is not None:
            return yqs_record
