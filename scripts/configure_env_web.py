...
FIELDS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            ("FEISHU_KNOWLEDGE_SPACE_NAME", "知识库名称，回显同步使用", "YQS PPT 图片素材库", "text", ""),
            ("FEISHU_KNOWLEDGE_SPACE_ID", "已有知识库 space_id，可留空", "", "text", ""),
            ("FEISHU_KNOWLEDGE_ROOT_NODE_TOKEN", "知识库根节点 token，可留空", "", "text", ""),
            ("FEISHU_KNOWLEDGE_PARENT_TYPE", "知识库文件上传 parent_type", "wiki", "text", ""),
            ("FEISHU_KNOWLEDGE_FOLDER_OBJ_TYPE", "知识库目录节点 obj_type", "docx", "text", ""),
            ("FEISHU_KNOWLEDGE_USER_ACCESS_TOKEN", "新建知识库需要的 user_access_token", "", "password", ""),
            ("FEISHU_KNOWLEDGE_FORCE_UPLOAD", "回显时强制重传图片", "false", "select", "true,false"),
            ("FEISHU_BITABLE_APP_TOKEN", "多维表格 app_token", "", "password", ""),
            ("FEISHU_BITABLE_TABLE_ID", "多维表格 table_id", "", "text", ""),
            ("FEISHU_BITABLE_VIEW_ID", "多维表格读取 view_id", "", "text", ""),
            ("FEISHU_BITABLE_FORM_VIEW_ID", "多维表格表单 view_id", "", "text", ""),
            ("FEISHU_BITABLE_FORM_URL", "飞书表单分享链接，表单命令优先使用", "", "text", ""),
            ("FEISHU_WEB_BASE_URL", "飞书网页域名", "https://www.feishu.cn", "text", ""),
            ("FEISHU_BITABLE_FIELD_NAME", "字段名：名字", "名字", "text", ""),
            ("FEISHU_BITABLE_FIELD_DESCRIPTION", "字段名：描述", "描述", "text", ""),
            ("FEISHU_BITABLE_FIELD_PROJECT", "字段名：项目", "项目", "text", ""),
            ("FEISHU_BITABLE_FIELD_FILE", "字段名：文件", "文件", "text", ""),
            ("FEISHU_BITABLE_FIELD_SOURCE", "字段名：来源", "来源", "text", ""),
            ("FEISHU_BITABLE_FIELD_SOURCE_SUBCATEGORY", "字段名：来源二级分类", "来源二级分类", "text", ""),
            ("FEISHU_BITABLE_FIELD_COMMERCIAL", "字段名：是否可商用", "是否可商用", "text", ""),
            ("FEISHU_BITABLE_FIELD_USABLE", "兼容旧字段名，可留空", "是否可商用", "text", ""),
...
ROOT_ENV_KEYS = [
    ...
    "FEISHU_KNOWLEDGE_SPACE_NAME",
    "FEISHU_KNOWLEDGE_SPACE_ID",
    "FEISHU_KNOWLEDGE_ROOT_NODE_TOKEN",
    "FEISHU_KNOWLEDGE_PARENT_TYPE",
    "FEISHU_KNOWLEDGE_FOLDER_OBJ_TYPE",
    "FEISHU_KNOWLEDGE_USER_ACCESS_TOKEN",
    "FEISHU_KNOWLEDGE_FORCE_UPLOAD",
    ...
    "FEISHU_BITABLE_FIELD_PROJECT",
    "FEISHU_BITABLE_FIELD_FILE",
    "FEISHU_BITABLE_FIELD_SOURCE",
    "FEISHU_BITABLE_FIELD_SOURCE_SUBCATEGORY",
    "FEISHU_BITABLE_FIELD_COMMERCIAL",
